...
static bool db_put(app_t *app, const char *type, const void *key_data, size_t key_size, const void *value_data,
                   size_t value_size)
{
    MDB_val mdb_key = {
        .mv_size = key_size,
...
static const void *db_get_meta(app_t *app, db_table_t table)
{
