...
typedef struct telebot_message {
     ...
     */
    telebot_message_entity_arr_t entities;

    /**
     * Optional. For messages with a caption, special entities like usernames,
     * URLs, bot commands, etc. that appear in the caption.
     */
    telebot_message_entity_arr_t caption_entities;
...
typedef struct telebot_webhook_info {
     ...
     */
    telebot_update_type_t allowed_updates[TELEBOT_UPDATE_TYPE_MAX];
