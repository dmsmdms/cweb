...
#define log_error(fmt, ...) log_write(&log_mod, LOG_LVL_ERROR, __LINE__, __func__, fmt, ##__VA_ARGS__)
#define log_warn(fmt, ...)  log_write(&log_mod, LOG_LVL_WARN, __LINE__, __func__, fmt, ##__VA_ARGS__)
#define log_info(fmt, ...)  log_write(&log_mod, LOG_LVL_INFO, __LINE__, __func__, fmt, ##__VA_ARGS__)
#define log_debug(fmt, ...) log_write(&log_mod, LOG_LVL_DEBUG, __LINE__, __func__, fmt, ##__VA_ARGS__)
